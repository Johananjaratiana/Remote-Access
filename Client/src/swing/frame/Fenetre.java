...
public class Fenetre extends JFrame{
    ...
    public Fenetre() throws HeadlessException, IOException {                                     // insert Server_data
        ...
        this.setMenu(new Menu(this.width,this.heigth,this));
    ...
    public  Fenetre(ClientSocket clientSocket) {              // Le Meme clientSocket qui l` appelle
        ...
        this.getImagePanel().launch(clientSocket);            // souris et screen resolution
    ...
    public void add_one_Connected(JButton new_connected) {
        this.add(new_connected);
    }
}
