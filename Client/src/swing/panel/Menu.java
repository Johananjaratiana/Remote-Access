...
public class Menu extends JPanel {
    ...
    public Menu(int width, int height, Fenetre fenetre) throws IOException {
        ...
        this.addLabel(0,margin_v,width/2,margin_v,"IP_ADRESS",font_size);       // etiquette IP
        ...
        this.addLabel(0,margin_v*5,width/2,margin_v,"PORT",font_size);      // etiquette Port
        ...
        this.addLabel(0,margin_v*9,width/2,margin_v,"RECONNAISSANCE",font_size);// etiquette Reconaissance
        ...
        connect.setBackground(new Color(0, 117, 0));
